...
RStudio
========================================================
RStudio makes R, the popular open source software environment for statistical computing and graphics, easier to use by providing a code editor, debugging and visualization tools, and much more. 
